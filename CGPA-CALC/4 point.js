//Function to control the get cgpa modal
    $("#OpenBtn").click(function() {
      ...
      //Function to add the total units and points 
      ...
      else if (x < 2)  document.querySelector(".modal-body").innerHTML = "<strong>CGPA : " + x + " <br> Division: Third Class ";
      else if (x < 3)  document.querySelector(".modal-body").innerHTML = "<strong>CGPA : " + x + " <br> Division: Second Class Lower";
      else if (x < 3.5)  document.querySelector(".modal-body").innerHTML = "<strong>CGPA : " + x + " <br> Division: Second Class Upper";
